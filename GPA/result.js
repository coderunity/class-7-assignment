...
function Result(){
    ...
    this.fanalResult = function( bn,en,math,s,ss,rel ){
        ...
        let totalcgpa = this.gpacal(bn).gpa + this.gpacal(en).gpa + this.gpacal(math).gpa + this.gpacal(s).gpa + this.gpacal(ss).gpa + this.gpacal(rel).gpa ;
